...
# render
python ./render.py -m ./output/ORIGINAL/bicycle --config configs/mipnerf360/bicycle.yaml --skip_train --iteration -1 --resolution 4 | tee output/ORIGINAL/bicycle/logger/render.log
